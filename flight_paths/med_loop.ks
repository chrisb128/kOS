global function med_loop_plan {
    ...
    local turnNorth is createWaypoint(200, 3000, locationAfterDistanceAtHeading(legAxis, 0, 30000)).
    ...
    return createFlightPlan(200, 3000,
        med_loop_path,
        kscWest,
        kscEast
    ).
